            ...
            <div class="row">
                <div class="col-md-6 b-r">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            ...
                            <div class="radio">
                                <label>
                                    <input type="radio" name="hot" value="true" <#if food.hot>checked</#if>>
                                    是
                                </label>
                                <label>
                                    <input type="radio" name="hot" value="false"
                                           <#if !food.hot>checked</#if>> 否
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12">
                            ...
                            <div class="radio">
                                <label>
                                    <input type="radio" name="meat" value="true"
                                           <#if food.meat>checked</#if>> 是
                                </label>
                                <label>
                                    <input type="radio" name="meat" value="false"
                                           <#if !food.meat>checked</#if>> 否
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12">
                            ...
                            <div class="radio">
                                <label>
                                    <input type="radio" name="muslim" value="true"
                                           <#if food.muslim>checked</#if>> 是
                                </label>
                                <label>
                                    <input type="radio" name="muslim" value="false"
                                           <#if !food.muslim>checked</#if>> 否
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <div class="col-sm-12">
                            <label>菜品图片</label>
                            <#if food.imagePath?exists>
                                <a href="#" class="thumbnail">
                                    <img src="/rtat/foods/img/${food.id}">
                                </a>
                            </#if>
