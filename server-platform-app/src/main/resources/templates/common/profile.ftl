...
<#macro show>
    <#assign restaurant=Session['session_key_restaurant']/>
    ...
    <@tags.shiro.user>
        <div class="profile-element text-center">
            <span>
                ...
                <#if !restaurant.opening>
                    <div id="profile-open-status" class="badge badge-danger" title="线上整顿中"
                         style="position: absolute; margin-left: -10px; cursor: pointer;">停
                    </div>
                <#else>
            ...
            <div class="pad10-tb">
                ...
                <span class="block m-t-xs" title="${restaurant.memo!}" data-toggle="tooltip">
                    <strong class="font-bold">${restaurant.name!}</strong>
                </span>
                </a>
            </div>
        </div>
